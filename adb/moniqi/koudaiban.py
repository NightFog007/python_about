...
def click_all_button(): #右下角继续任务的按钮,可以放个线程一直点击
    print("开始点击右下角")
    while 1> 0:
...
def find_gui(name):
    ...
    while x < 0:
        ...
        # name = 'mamian'
        for i in sttr:
            gui_pic = './gui_pic/{}_{}.jpg'.format(name,i)
...
def isPintu(): #^ 是拼图则返回-1
    jiepin()
    sleep(1)
    nn = matchImg('home.jpg','pintu_jiemian.jpg')
...
def zhaogui():
    ...
    jiepin()
    jiangshi = matchImg('home.jpg','./gui_pic/wenzi_jiangshi.jpg',0.3)
    niutou = matchImg('home.jpg','./gui_pic/wenzi_niutou.jpg',0.3) 
    mamian = matchImg('home.jpg','./gui_pic/wenzi_mamian.jpg',0.3) 
    yegui = matchImg('home.jpg','./gui_pic/wenzi_yegui.jpg',0.3) 
    kulouguai = matchImg('home.jpg','./gui_pic/wenzi_kulouguai.jpg',0.3) 
    paojiu = matchImg('home.jpg','./gui_pic/wenzi_jiu.jpg')
    
    xunwu = matchImg('home.jpg','./gui_pic/wenzi_xunwu.jpg') 
...
def isFight_once():  #战斗中,返回-1
    res = 0
    xx = matchImg('home.jpg','huihe.jpg')
...
jiepin()   
# click_youxiajiao() 
# yegui = matchImg('home.jpg','./gui_pic/wenzi_yegui.jpg',0.1) 